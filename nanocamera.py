# From https://github.com/thehapyone/NanoCamera
# Allow different capture size
...
class Camera:
    def __init__(self, camera_type=0, device_id=0, source="localhost:8080", flip=0, width=640, height=480, fps=30,
                 enforce_fps=False, debug=False, capture_width=None, capture_height=None):
        ...
        self.capture_width = capture_width or self.width
        self.capture_height = capture_height or self.height
